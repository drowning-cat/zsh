...
_Skip this step if `ttf-meslo-nerd` is installed (*Arch repository: Extra*)._
...
46: source "$ZFOLDER/plugins/fzf.zsh"
```
...
```sh #link ~/.config/zsh/plugins/fzf.zsh
39: export FZF_CTRL_T_OPTS="--preview '[[ -d {} ]] && tree -C {} || bat --style numbers --color always --line-range :500 {}'"
40: export FZF_ALT_C_OPTS="--preview 'tree -C {}'"
41: export FZF_COMPLETION_DIR_COMMANDS="cd pushd rmdir tree ls"
```
...
```sh #link ~/.config/zsh/zshrc
62: alias ls='eza --icons auto'
63: alias ll='eza --icons auto --long --all'
64: alias lt='eza --icons auto --tree --level=5'
```
...
```sh #link ~/.config/zsh/zshrc
51: path+=("$HOME/.local/share/fnm")
...
53: eval "$(fnm env --use-on-cd)"
```
...
...
69: alias v='nvim'; alias vi='v'; alias vim='v'
70: alias svim='sudo -Es nvim'; alias sv='svim'
```
