...
```sh
paru -s zsh fzf fd tree eza zoxide neovim wl-clipboard trash-cli github-cli keychain fnm
```
...
```sh #link ~/.config/zsh/plugins/fzf.zsh
16: export FZF_CTRL_T_OPTS="--preview '[[ -d {} ]] && tree -C {} || bat --style numbers --color always --line-range :500 {}'"
17: export FZF_ALT_C_OPTS="--preview 'tree -C {}'"
18: export FZF_COMPLETION_DIR_COMMANDS="cd pushd rmdir tree ls"
```
