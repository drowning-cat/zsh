...
() {
  ...
  bind -a '^l' forward-char                  # Ctrl + l
  bind -a '^h' backward-char                 # Ctrl + h
  bind -a '^k' up-line-or-beginning-search   # Ctrl + k
  bind -a '^j' down-line-or-beginning-search # Ctrl + j

  bind -c '^_'  redo # Ctrl + Shift + -
  bind -c '^[r' redo # Alt + r
}
